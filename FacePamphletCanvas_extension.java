...
public class FacePamphletCanvas_extension extends GCanvas 
	 ...
	 * the display
	 */
	public FacePamphletCanvas_extension() {
		// You fill this in
	}
	 ...
	 */
	public void displayProfile(FacePamphletProfile_extension profile) {
		drawName(profile);
		drawImage(profile);
		drawStatus(profile);
		drawFriends(profile);
	...
	private void drawName(FacePamphletProfile_extension profile) {
	...
	private void drawImage(FacePamphletProfile_extension profile) {
	...
	private void drawStatus(FacePamphletProfile_extension profile) {
		...
		statusLabel = new GLabel(curStatus);
	...
	private void drawFriends(FacePamphletProfile_extension profile) {
	...
	private void drawSex(FacePamphletProfile_extension profile) {
		...
		if(gender.equals("")) {
			...
			curGender = profile.getName() + " is " + profile.getSex();
		}
		GLabel sex = new GLabel(curGender);
		sex.setFont(PROFILE_STATUS_FONT);
		if(getElementAt(LEFT_MARGIN, IMAGE_MARGIN + nameLabel.getHeight() + IMAGE_MARGIN + IMAGE_HEIGHT + statusLabel.getHeight() + sex.getHeight()) != null) {
			remove(getElementAt(LEFT_MARGIN, IMAGE_MARGIN + nameLabel.getHeight() + IMAGE_MARGIN + IMAGE_HEIGHT + statusLabel.getHeight() + sex.getHeight()));
		}
		add(sex, LEFT_MARGIN, IMAGE_MARGIN + nameLabel.getHeight() + IMAGE_MARGIN + IMAGE_HEIGHT + statusLabel.getHeight() + sex.getHeight());
		}
